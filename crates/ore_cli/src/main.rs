...
fn map_runtime_functions(
    ...
    map_fn!("ore_str_lines", ore_runtime::ore_str_lines);
    ...
    map_fn!("ore_str_count", ore_runtime::ore_str_count);
    map_fn!("ore_str_strip_prefix", ore_runtime::ore_str_strip_prefix);
    map_fn!("ore_str_strip_suffix", ore_runtime::ore_str_strip_suffix);
    ...
    map_fn!("ore_list_window", ore_runtime::ore_list_window);
    map_fn!("ore_list_chunks", ore_runtime::ore_list_chunks);
    // Lists
    ...
    map_fn!("ore_list_insert", ore_runtime::ore_list_insert);
    map_fn!("ore_list_remove_at", ore_runtime::ore_list_remove_at);
    map_fn!("ore_list_scan", ore_runtime::ore_list_scan);
    ...
    map_fn!("ore_list_zip_with", ore_runtime::ore_list_zip_with);
    ...
    map_fn!("ore_list_repeat", ore_runtime::ore_list_repeat);
    ...
    map_fn!("ore_ord", ore_runtime::ore_ord);
    map_fn!("ore_chr", ore_runtime::ore_chr);
    ...
    map_fn!("ore_list_index_of_str", ore_runtime::ore_list_index_of_str);
    ...
    map_fn!("ore_list_map_with_index", ore_runtime::ore_list_map_with_index);
    map_fn!("ore_list_each_with_index", ore_runtime::ore_list_each_with_index);
    map_fn!("ore_list_to_map", ore_runtime::ore_list_to_map);
