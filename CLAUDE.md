...
**YOU ARE IN: `ore/polecats/scavenger/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ore/` (rig root) or other directories
...
**Your mail address:** `ore/polecats/scavenger`
**Your rig:** ore
**Your Witness:** `ore/witness`
...
| Ask Witness for help | `gt mail send ore/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`ore/witness`) when:
...
```bash
gt mail send ore/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
